# Build docs/index.html from docs/SYNTAX.md.
#
...
SOURCE = os.path.join(ROOT, 'docs', 'SYNTAX.md')
PAGE = os.path.join(ROOT, 'docs', 'index.html')

TITLE = 'Astra syntax'
LEDE = ('Every form the language has, on one page. Each one is exercised by a '
        'gate or by a running program.')
...
<h1>{title}</h1>
<p class="lede">{lede}</p>
<p class="lede"><a href="https://github.com/Lone-Lodge/astra">The repository</a>
is where the gates live: <code>orbit run</code> proves every form below.</p>
</header>
...
<footer>
<p>Astra is written in <a href="https://github.com/Lone-Lodge/orion">Orion</a>
and embedded by a host, which decides what these declarations mean.</p>
</footer>
...
if __name__ == '__main__':
    ...
    if '--check' in sys.argv:
        ...
        if have.replace('\r\n', '\n') != page:
            ...
            sys.exit(1)
        print('  guide: docs/index.html matches docs/SYNTAX.md')
    else:
        open(PAGE, 'w', encoding='utf-8', newline='').write(page)
        print('  guide: docs/index.html written from docs/SYNTAX.md')
